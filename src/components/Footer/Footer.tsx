    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-10 items-start">
        ...
        <div>
          <a
            href="#"
            className="text-xl font-bold tracking-tight text-[#0D2E26] focus-visible:ring-2 focus-visible:ring-[#82C21C] rounded"
            aria-label="Click Aarambh Ventures Home"
          >
            Click <span className="text-[#70BA28]">Aarambh</span>
          </a>
          <p className="text-sm text-[#0D2E26]/30 mt-3 leading-relaxed max-w-xs">
        ...
        <div className="flex flex-col gap-3">
          <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#0D2E26]/20 mb-1">Navigate</span>
          {["Approach", "Capabilities", "Impact"].map(link => (
            <a
              key={link}
              href={`#${link.toLowerCase()}`}
              className="text-sm text-[#4B635D] hover:text-[#0D2E26] transition-colors focus-visible:ring-2 focus-visible:ring-[#82C21C] rounded"
        ...
        <div className="flex flex-col items-start md:items-end gap-4">
          <button
            className="px-6 py-3 text-sm font-bold uppercase tracking-wider bg-[#70BA28] text-[#061917] rounded-lg focus-visible:ring-2 focus-visible:ring-[#82C21C] focus-visible:ring-offset-2 focus-visible:ring-offset-[#061917]"
          ...
          <p className="text-xs text-[#0D2E26]/20">
