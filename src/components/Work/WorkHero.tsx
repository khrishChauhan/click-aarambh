...
export default function WorkHero() {
  ...
  return (
    <section 
      className="relative flex min-h-screen w-full flex-col items-center justify-center bg-[#F4F7F5] px-6 md:px-12 lg:px-24"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl text-center">
        <motion.h1
          className="mx-auto max-w-4xl font-extrabold leading-[1.05] tracking-[-0.04em] text-[#0D2E26]"
        ...
        <motion.p
          className="mx-auto mt-8 max-w-[500px] text-[clamp(1.1rem,1.5vw,1.35rem)] leading-[1.6] text-[#4B635D]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
