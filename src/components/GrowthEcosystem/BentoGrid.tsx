      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="mb-16">
          <div className="flex items-center gap-3 mb-4">
            ...
            <span className="text-[10px] font-mono uppercase tracking-[0.25em] text-[#2E4D45]">The Ecosystem</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-[-0.03em] text-[#0D2E26] leading-[0.9]">
            One Engine.<br />
            <span className="text-[#2E4D45]">Four Disciplines.</span>
          </h2>
        </div>
...
const BentoCard = ({
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 left-4 right-4 h-px bg-gradient-to-r from-transparent via-[#70BA28]/0 to-transparent group-hover:via-[#70BA28]/20 pointer-events-none"
           style={{ transition: "opacity 0.4s ease" }} />

      <div className="relative z-10 flex flex-col h-full">
        {/* Tag + title row */}
        <div className="flex items-start justify-between mb-5">
          <span className="text-[10px] font-mono text-[#2E4D45] tracking-widest">{tag}</span>
        </div>
        ...
        <div className="mt-8 flex items-center gap-2">
          ...
          <a
            href="#contact"
            className="text-xs font-semibold text-[#2E4D45] group-hover:text-[#70BA28] tracking-wider uppercase focus:outline-none focus-visible:underline"
