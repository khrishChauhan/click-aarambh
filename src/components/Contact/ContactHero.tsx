...
export default function ContactHero() {
  ...
  return (
    <section className="relative flex flex-col items-center justify-center bg-transparent px-6 pt-40 pb-16 md:px-12 lg:px-24">
      ...
      <div 
        aria-hidden="true"
        className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-[40vh] w-[60vw] rounded-full bg-[#70BA28] opacity-[0.05] blur-[100px]" 
      />

      <div className="relative z-10 w-full max-w-4xl text-center">
        <motion.p
          className="mb-6 font-mono text-[11px] uppercase tracking-[0.2em] text-[#70BA28]"
        ...
        <motion.h1
          className="mx-auto font-extrabold leading-[1.05] tracking-[-0.04em] text-[#0D2E26]"
        ...
        >
          ...
          <span className="text-[#70BA28] inline-block min-w-[3em] text-left">
            {scrambledScales}
          </span>
        </motion.h1>

        <motion.p
          className="mx-auto mt-8 max-w-2xl text-[clamp(1.1rem,1.5vw,1.35rem)] leading-[1.6] text-[#2E4D45]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
